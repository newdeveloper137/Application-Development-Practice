...
def beef_stuff(amount):
    ...
    if order_amount > max_order:
        ...
        order_price = str(round((price*order_amount),2))
        msg = str(order_amount) + " is the maximum order amount and costs $" + order_price + " Link to Checkout:"
    else:
        order_price = str(round((price*order_amount),2))
        ...
        while msg == str(order_amount) + " pounds costs $" + order_price:
            ...
            if more_beef == "yes":
                ...
                if (order_amount + order_amount_2) > max_order:
                    order_amount_3 = order_amount + order_amount_2
                    msg = str(order_amount_3) + " pounds is more than currently available stock. Try again."
                    while msg == str(order_amount_3) + " pounds is more than currently available stock. Try again.":
                        print(msg)
